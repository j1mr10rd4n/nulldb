...
== DON'T DELETE ME!!!
At least until the project is fully migrated!
...
This fork of NullDB was made to get the library running in a project
based on rails-2.3.x which is in the process of being upgraded. If 
you delete this fork, that project won't build!!
